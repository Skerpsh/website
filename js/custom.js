document.addEventListener("DOMContentLoaded", () => {
    ...
    function initializeAnimations() {
        ...
        function initTypewriter() {
            ...
            const phrases = [
                "Engineering security for the future",
                "The backbone of modern European defense",
                "Advanced technology for defense and mobility",
                "Power, precision, and protection",
                "High-tech defense made in Europe",
                "Precision under pressure",
                "Engineering tomorrow’s battlefield",
                "Modern warfare engineering"
            ];
